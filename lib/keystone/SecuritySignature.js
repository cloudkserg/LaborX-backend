...
SecuritySignature.add({
  type: {
    ...
    options: [
      ...
      { value: 'bitcoin-gold-address', label: 'Bitcoin Gold Address' },
      { value: 'bitcoin-cache-address', label: 'Bitcoin Cache Address' },
      { value: 'bitcoin-litecoin-address', label: 'Litecoin Address' },
